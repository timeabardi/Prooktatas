<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h1 class="font-semibold text-xl text-gray-800 leading-tight pb-10">Create event</h1>
    ...
    <form method="POST" action="{{ route('events.store') }}">
        ...
        <div class="grid grid-cols-2 gap-2 w-full max-w-lg">
            ...
            <div>
            <input type="submit" class="bg-green-700 hover:bg-green-600 text-white font-bold w-full py-2 px-4 rounded cursor-pointer" value="Save a new event">
            </div>
        </div>
    </form>
